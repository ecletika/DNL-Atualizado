...
import { Calendar, Hammer, Clock, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';

const Ongoing: React.FC = () => {
  const { projects } = useApp();

  // Filtragem rigorosa por status "Em Andamento"
    ...
    <div className="min-h-screen bg-[#F5F5F5] pt-32 md:pt-40 pb-20 animate-fade-in">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 font-['Open_Sans'] max-w-2xl mx-auto text-lg">
            Acompanhe em tempo real a evolução dos nossos projetos atuais. Garantimos organização, limpeza e cumprimento de prazos.
          </p>
        </div>
        ...
        {ongoingProjects.length > 0 ? (
              ...
              <div key={project.id} className="bg-white rounded-[2.5rem] overflow-hidden shadow-xl border border-gray-100 group hover:-translate-y-2 transition-all duration-500">
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="bg-[#FFA500] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-lg">
                      {project.type}
                    </span>
                  </div>
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-gradient-to-r from-[#1F4E79] to-[#FFA500] transition-all duration-1000 ease-out rounded-full"
          ...
          <div className="text-center py-32 bg-white rounded-[3rem] shadow-sm border border-dashed border-gray-200">
            ...
            <p className="text-gray-400 max-w-md mx-auto mb-8 font-['Open_Sans']">
              Estamos a preparar novos projetos incríveis. Enquanto isso, espreite o nosso portfólio de obras concluídas.
            </p>
            <Link to="/portfolio" className="inline-flex items-center gap-2 text-[#1F4E79] font-bold hover:text-[#FFA500] transition-colors uppercase text-sm tracking-widest">
              Ver Portfólio Concluído <ArrowRight size={18} />
            </Link>
          </div>
        )}
      </div>
